...
window.FORGE_VERSION = 'v217';
window.FORGE_BUILD   = '2026-03-17 (feat: coach triggers, recovery heatmap, macro steering, ghost mode, adaptive timer, PR overlay, voice-to-log, RAG form check)';
